...
const Layout = ({ children }) => {
    ...
    return (
        <div>
            <LeftNavigationMenu isLeftNavigationOpen={isLeftNavigationOpen}></LeftNavigationMenu>
            <div id="pg-content" className="pg-content relative" style={{ "marginLeft": isLeftNavigationOpen ? "250px" : "0px" }}>
                <Header handleLeftNavigation={handleLeftNavigation} isLeftNavigationOpen={isLeftNavigationOpen}></Header>
